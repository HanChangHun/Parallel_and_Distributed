/*****************************************************
  ...
  In file access and result verification in matrixmatrix
  multiplication.]
  Description []
 ******************************************************/
FILE *OpenFile(const char *const fn_p, const char *const open_mode_p,
...
unsigned int *ReadMatrixFile(const char *const matrix_fn_p,
                             const unsigned int M_WIDTH,  // matrix width
                             const unsigned int M_HEIGHT, // matrix height
                             const int if_silent // If not show messages
) {
